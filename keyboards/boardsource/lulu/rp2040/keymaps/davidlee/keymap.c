...
KC_LSFT,  KC_X,    KC_Q,    KC_M,  KC_W,    KC_Z,    ENC_B1,  ENC_B2,  KC_K,    KC_F,    KC_QUOT, KC_SCLN, KC_DOT,  ENT_SFT,
...
[_NUM] = LAYOUT(
KC_MINS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   _______,
VOICE,   KC_EXLM, KC_AT,   KC_HASH, KC_EQUAL,KC_LPRN,                   KC_RPRN, KC_AMPR, KC_ASTR, KC_MINS, KC_PLUS,  _______,
...
KC_TAB,   KC_B,    KC_L,    KC_D,  KC_C,    KC_V,                      KC_J,    KC_Y,    KC_O,    KC_U,    KC_COMM, KC_BSLS,
KC_ESC,   KC_N,    KC_R,    KC_T,  KC_S,    KC_G,                      KC_P,    KC_H,    KC_A,    KC_E,    KC_I,    KC_SLASH,
KC_LSFT,  KC_X,    KC_Q,    KC_M,  KC_W,    KC_Z,    ENC_B1,  ENC_B2,  KC_K,    KC_F,    KC_QUOT, KC_SCLN, KC_DOT,  ENT_SFT,
